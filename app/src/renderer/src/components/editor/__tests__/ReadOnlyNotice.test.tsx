...
describe('ReadOnlyNotice', () => {
  ...
  it('explains a generated file in its own words, with no way out', () => {
    render(
      <ReadOnlyNotice kind="reference" name="INDEX.md" tier={null} generated onEditCopy={vi.fn()} />
    )
    expect(screen.getByRole('status').textContent).toMatch(/generated by reference sync/i)
    expect(screen.getByRole('status').textContent).toMatch(/overwritten on the next sync/i)
