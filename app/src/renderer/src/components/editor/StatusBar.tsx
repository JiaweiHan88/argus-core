...
export function StatusBar({
  ...
  return (
    <div className="flex shrink-0 items-center justify-between gap-3 glass-chrome rounded-none border-x-0 border-b-0 px-3 py-1 font-mono text-[11px] text-faint">
