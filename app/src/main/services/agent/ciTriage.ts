...
4. Call append_finding with a severity and a citation to the evidence line the failure is on,
   written as [artifacts/<file>:<line>] using the stored path fetch_check_logs reported — NOT the
   evidence_id ("[evidence 3:12]" renders as dead text; "[artifacts/ci-4-lint.log:12]" is a
