...
export function seedMemoryPair(
  ...
  ingestArtifact(db, argusHome, 'NAV-100', path.join(FIXTURES, 'memory-pair-a-applog.txt'))
  ingestArtifact(db, argusHome, 'NAV-200', path.join(FIXTURES, 'memory-pair-b-applog.txt'))
  return { a, b }
}
